        ...
        >
          {msg && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className={`text-center text-xs font-medium py-2 rounded-lg mb-4 ${
                msgType === "success"
            ...
            >
              ...
              <form onSubmit={handleVerifyOTP} className="flex flex-col gap-4">
                <input
                  ...
                  className="w-full px-4 py-4 text-center text-3xl tracking-[0.5em] font-mono rounded-xl bg-white/50 border border-white/40 
                ...
                <motion.button
                  ...
                  shadow-lg shadow-green-500/30 transition-all cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
                >
                ...
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="mt-2 text-sm text-gray-500 hover:text-blue-600 transition-colors"
                >
                  ← Back to Login
                </button>
              </form>
